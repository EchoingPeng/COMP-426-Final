...
async function reHoro(event) {
    ...
    let horo=localStorage.currentzodiac;
    let horo1;
    switch(evid){
        case "1": horo1=await todayHoro(horo);
        break;
        case "2": horo1=await weekHoro(horo);
        break;
        case "3": horo1=await monthHoro(horo);
        break;
        case "4": horo1=await yearHoro(horo);
        break;
    }
    let $newHoro = $(
        `<div id="newhoro">
